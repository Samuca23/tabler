                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="codigo_barra" placeholder="78978978978978">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control text-right" aria-label="Valor" name="valor_unidade">
                        </div>
                      </div>
                    </div>
                  </div>
